...
exports.KATEX_MACROS = exports.UNICODE_SUBSCRIPTS = exports.UNICODE_SUPERSCRIPTS = exports.UNICODE_MATH_MAP = exports.LATEX_ENVIRONMENTS = exports.LATEX_SYMBOLS = exports.LATEX_COMMANDS = void 0;
exports.buildCommandRegexSource = buildCommandRegexSource;
exports.buildSymbolRegexSource = buildSymbolRegexSource;
...
function buildCommandRegexSource() {
    ...
    var sorted = __spreadArray([], exports.LATEX_COMMANDS, true).sort(function (a, b) { return b.length - a.length; });
    return sorted.join('|');
}
/** Regex fragment matching any known LaTeX symbol (without leading backslash) */
function buildSymbolRegexSource() {
    var sorted = __spreadArray([], exports.LATEX_SYMBOLS, true).sort(function (a, b) { return b.length - a.length; });
    return sorted.join('|');
}
